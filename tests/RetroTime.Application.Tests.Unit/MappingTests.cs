...
namespace RetroTime.Application.Tests.Unit;
...
public sealed class MappingTests : MappingTestBase {
    ...
    public void ShouldMap_NoteLane_ToRetrospectiveLane() {
        ...
        // When
        var mapped = this.Mapper.Map<RetroTime.Application.Retrospectives.Queries.GetRetrospectiveStatus.RetrospectiveLane>(entity);
